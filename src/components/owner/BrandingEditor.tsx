      ...
      <div className="space-y-6">
        ...
        <div className="p-4 rounded-xl bg-white border border-[#F3C6D3] flex items-center justify-between">
          ...
          <button
            ...
            className={`px-4 py-2 rounded-full text-xs font-bold cursor-pointer flex items-center gap-1.5 ${
              brandSettings.showIcon !== false
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleFooterChange('id', e.target.value)}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleFooterChange('en', e.target.value)}
                className="w-full px-4 py-2 rounded-xl border border-[#F3C6D3] text-xs text-[#2D292B]"
              />
            </div>
          </div>
